...
#define STDLIB_NAPI_ARGV_BOOL( env, name, argv, index )                      \
	...
	bool name;                                                               \
	stdlib_napi_argv_bool( env, argv[ index ], &name, "invalid argument. " STDLIB_NAPI_ARGV_INDEX2ORDINAL( index ) " argument must be a bool.", &__STDLIB_NAPI_ARGV_BOOL_ERR_ ## name ); \
