...
double v = stdlib_strided_dmeanpw( 4, x, 2 );
// returns ~0.3333
```
...
```c
void stdlib_strided_dmeanpw( const CBLAS_INT N, const double *X, const CBLAS_INT strideX );
```
...
double v = stdlib_strided_dmeanpw_ndarray( 4, x, 2, 0 );
// returns ~0.3333
```
