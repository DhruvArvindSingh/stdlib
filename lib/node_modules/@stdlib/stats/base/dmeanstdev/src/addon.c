...
static napi_value addon( napi_env env, napi_callback_info info ) {
	...
	STDLIB_NAPI_ARGV_STRIDED_FLOAT64ARRAY( env, Out, N, strideX, argv, 4 );
	STDLIB_NAPI_CREATE_DOUBLE( env, stdlib_strided_dmeanstdev( N, correction, X, strideX, Out, strideOut ), v );
	return v;
}
