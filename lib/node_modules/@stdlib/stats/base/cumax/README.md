...
#### stdlib_strided_cumax( N, \*X, strideX, \*Y, strideY )
...
stdlib_strided_cumax( 4, x, 2, y, -2 );
```
...
```c
void stdlib_strided_cumax( const CBLAS_INT N, const float *X, const CBLAS_INT strideX, float *Y, const CBLAS_INT strideY );
```

#### stdlib_strided_cumax_ndarray( N, \*X, strideX, offsetX, \*Y, strideY, offsetY )
...
stdlib_strided_cumax_ndarray( 4, x, 2, 0, y, -2, 0 );
```
...
```c
void stdlib_strided_cumax_ndarray( const CBLAS_INT N, const float *X, const CBLAS_INT strideX, const CBLAS_INT offsetX, float *Y, const CBLAS_INT strideY, const CBLAS_INT offsetY );
```
