...
tape( 'if provided `+infinity` for `x` and a finite `mu` and `b`, the function returns `1`', opts, function test( t ) {
...
tape( 'the function evaluates the cdf for `x` given large variance ( = large `b` )', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var mu;
